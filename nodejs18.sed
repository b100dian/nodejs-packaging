s/{{node_version}}/18.14.0/g
s/{{node_version_major}}/18/g

#
#
# openssl version - need OpenSSL 1.1.1+
s/{{intree_openssl}}/0%{?suse_version} >= 1500 || 0%{?sle_version} >= 120400 || 0%{?fedora_version} >= 35 || 0%{?sailfishos_version}/g
#
#
# icu versions
...
s/{{bundled_openssl_version}}/3.0.7/g
s/{{bundled_uv_version}}/1.44.2/g
s/{{bundled_uvwasi_version}}/0.0.14/g
s/{{bundled_v8_version}}/10.2.154.23/g
